...
namespace SpriteFramework
{
    ...
    public class GameEntry : MonoBehaviour
    {
        ...
        private void Awake()
        {
            Log(ELogCategory.Procedure, "GameEntry.OnAwake()");
            Instance = this;
        ...
        private void Start()
        {
            Log(ELogCategory.Procedure, "GameEntry.OnStart()");
        ...
        {
            Log(ELogCategory.Normal, message);
        }
        public static void Log(ELogCategory catetory, object message)
        {
#if DEBUG_LOG_NORMAL
        ...
        {
            LogWarning(ELogCategory.Normal, message);
        }

        public static void LogWarning(ELogCategory catetory, object message)
        {
        ...
        {
            LogError(ELogCategory.Normal, message);
        }

        public static void LogError(ELogCategory catetory, object message)
        {
#if DEBUG_LOG_ERROR
