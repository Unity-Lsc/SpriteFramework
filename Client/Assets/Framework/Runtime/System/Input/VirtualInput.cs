...
public abstract class VirtualInput : FsmState<InputManager>
{
    ...
    public void RegisterVirtualAxis(VirtualAxis axis)
    {
        ...
        {
            GameEntry.LogError(ELogCategory.Framework, "已经有了一个虚拟轴 " + axis.Name + " 重复注册.");
        }
        else
        {
    ...
    public void RegisterVirtualButton(VirtualButton button)
    {
        ...
        {
            GameEntry.LogError(ELogCategory.Framework, "There is already a virtual button named " + button.Name + " registered.");
        }
        else
        {
