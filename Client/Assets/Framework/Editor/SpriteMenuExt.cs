...
public class SpriteMenuExt
{
    #region 编辑器SpriteTools
    [MenuItem("SpriteTools/打开persistentDataPath")]
    ...
    [MenuItem("SpriteTools/设置文件动画循环为true")]
    ...
    [MenuItem("SpriteTools/生成并拷贝热更新程序集到Download文件夹")]
    public static void CompiltHotifxDll()
    {
        ...
        {
            Debug.LogError("请先构建一次当前平台的AOT补充程序集，路径：" + aotMetaAssemblyDir);
        }
    }

    [MenuItem("SpriteTools/打开全局参数设置")]
    public static void OpenParamsSettings()
    {
        Object asset = AssetDatabase.LoadAssetAtPath<Object>(SFConstDefine.FrameworkCoreFolderPath + "SpriteAssets/ParamsSettings.asset");
        Selection.activeObject = asset;
        EditorGUIUtility.PingObject(asset);// 高亮选中资源（可选）
    }

    [MenuItem("SpriteTools/打开宏设置")]
    public static void OpenMacroSettings()
    {
        Object asset = AssetDatabase.LoadAssetAtPath<Object>(SFConstDefine.FrameworkEditorFolderPath + "SpriteAssets/MacroSettings.asset");
        Selection.activeObject = asset;
        EditorGUIUtility.PingObject(asset);// 高亮选中资源（可选）
    }

    [MenuItem("SpriteTools/打开类对象池计数界面")]
    public static void OpenPoolAnalyze_ClassObjectPool()
    {
        Object asset = AssetDatabase.LoadAssetAtPath<Object>(SFConstDefine.FrameworkEditorFolderPath + "SpriteAssets/PoolAnalyze_ClassObjectPool.asset");
        Selection.activeObject = asset;
        EditorGUIUtility.PingObject(asset);// 高亮选中资源（可选）
    }
    #endregion
    ...
    [MenuItem("Assets/SpriteMenuExt/收集多个文件的路径到剪切板")]
    ...
    [MenuItem("Assets/SpriteMenuExt/收集多个文件的路径到剪切板(Resources)")]
    ...
    [MenuItem("Assets/SpriteMenuExt/收集多个文件的名字到剪切板")]
